...
import com.xupz.manhuareade.App;
import com.xupz.manhuareade.R;
import com.xupz.manhuareade.adapter.BookCollectionAdapter;
import com.xupz.manhuareade.adapter.DecompressPasswordAdapter;
...
import com.xupz.manhuareade.ui.fragment.DecompressPasswordInputFragment;
import com.xupz.manhuareade.ui.fragment.InternalStorageListFragment;
...
public class BookCollectionActivity extends BaseActivity
    ...
    public void changeAppIcon(String theme){
        ...
        switch (((App)getApplication()).startTheme){
            case "0":{
                pm.setComponentEnabledSetting(new ComponentName(this,"com.xupz.manhuareade.ui.activity.BookCollectionActivity"),
                        PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
                break;
            }
            case "1":{
                pm.setComponentEnabledSetting(new ComponentName(this, "com.xupz.manhuareade.SaSuKeActivity"),
                        PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
                break;
            }
            case "2":{
                pm.setComponentEnabledSetting(new ComponentName(this, "com.xupz.manhuareade.SaKuRaActivity"),
                        PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
                break;
            }
            case "3":{
                pm.setComponentEnabledSetting(new ComponentName(this, "com.xupz.manhuareade.RockLeeActivity"),
                        PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
                break;
            }
            default:{
