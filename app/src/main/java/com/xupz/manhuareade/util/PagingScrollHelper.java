...
public class PagingScrollHelper {
    ...
    public void unSetRecycleView(RecyclerView recyclerView){
    ...
    public void resetOffsetData(int nowPage){
        if(nowPage > startingPage){
            offsetX += (nowPage-startingPage) * mRecyclerView.getWidth();
            startX = offsetY;
        }else{
            offsetX -= (startingPage-nowPage) * mRecyclerView.getWidth();
            startX = offsetY;
        }
    }
